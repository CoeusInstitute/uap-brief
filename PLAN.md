...
- 2026-09-16 Core squad wave done: 10 squads, 84 files, 1,139 candidates, 65 missing-items logged; UP-0507 named gaps resolved (WOND / Ep 50 / Ep 82 / 10 Project Unity appearances). Queue loaded (84 pending; UP-0507 re-opened with 63 merged candidates) and processing; YouTube date backfill job running; source-less bulk run in background.- 2026-09-16 Crystal-caught: claim/release attempts bug zombied stalled queue rows; patched `complete_enrichment_item` (migration 20260916171500), unstuck 29 rows incl. UP-0507. Campaign continues.- 2026-09-16 Pool 1+2+3 complete: 250/250 queue done (0 failed), 3 python drain workers (~$1.4), coverage 848/849 (UP-0485 Shane Ryan candidate set was 100% same-name noise - under review), G3 core>=5 now 80/93 (13 thin-core targeted by Wave 4 depth squads), appearances 478, sources 4,876, dated 1,699. Majors bulk collecting (UP-0359 youtube phase). Liveness pass 1: 2,474 checked / 98.4% alive.- 2026-09-16 G2 MET: 849/849 people sourced (no orphans, no gaps); pool 1-3 closed 250/250 zero-failed; Shane Ryan (UP-0485) hand-resolved (Westall researcher, 8 sources written).- 2026-09-16 G3 MET: 93/93 core >=5 sources; snippet-inclusive name gate deployed (enrich-dossier); aliases fixed for Hoffman/Trump. Remaining gates: G6 edges (+22), G9 dates target, G13 final wave.- 2026-09-16 evening: G6 MET (edges 816); G9 MET (dated 61% overall; appearance types 83-98%); G10 MET (avg core 15.0 / major 8.1 / all 7.4). Majors draining (317/497 at last count). Photos track live (110+, wiki-by-name pass running).- 2026-09-16 17:14: Majors bulk complete (497/497 queue done, zero failed); 9,266 sources / 1,037 appearance edges. Final wave (352) launched. Photos: 255. Remaining: final wave drain, photo tail passes, date/liveness refreshes, closeout.- 2026-09-17 06:25: CAMPAIGN PROCESSING COMPLETE — 849/849 queue done, zero failed. 14,749 sources / 1,515 edges / avg 17.4 per person / coverage 100%. Closeout: liveness refresh + photo sweep + date backfill + docs.- 2026-09-17 (graph layer): built live edge layer — graph_edges 9 kinds / 7,525 edges (0.8s); minted 57 orgs (104 total, 255 aliases) -> affiliation edges 115 -> 506; co_story 717; host 51; org_mint_candidates queue (860). Docs: docs/graph-layer.md. Commit follows.- 2026-09-17 (live-layer support, Hermes): drained 40 story matches via match-entities invokes (cron continues; queue 276->221->draining); requeued 13 empty_rationale scoring failures; normalized person-name forms inserted into person_aliases (+206, matcher recall); normalizer v3 (unaccent); mint rounds 2-3 (23 orgs -> 119 total, 287 aliases; affiliation edges 506->547); graph_edges now 10 kinds / 8,597 edges (co_show added). Migration v2 recorded. Note: match-entities throws WORKER_RESOURCE_LIMIT under rapid-fire invokes - space them; cron handles backlog.- 2026-09-17 (data quality pass 2, Hermes): classified `other` person_sources -> typed (730->477; podcast +91, archive +103, mainstream +33, scholarly +7, x +19); links-phase re-run for majors+final wave launched (chained collect-links -> queue-load); cron liveness verified (all six live functions ticking within minutes).- 2026-09-17 (score-stories fix, Hermes): empty-rationale hard-throw removed -> per-dimension fail-soft + no_scorable_tags guard; deployed. The 13 stalled stories resolved (2 ready, 11 correctly re-gated off_topic); zero empty_rationale failures remain. Links re-runs: majors+final wave collections complete (247/247 + full list), queue-load draining via the enrich-dossier cron.- 2026-09-17 (links re-run + loader hardening, Hermes): queue-load now sanitizes unicode + per-person try/catch (was crashing whole runs on PGRST102 'empty or invalid json' at one file); re-load completed - 599 rows / 15,015 candidates; two drain workers launched (cron also ticks). person_links will grow as the queue drains.- 2026-09-17 (self-sustaining drain, Hermes): found enrich-dossier missing from the scheduler whitelist + no cron; extended whitelist + scheduled `uap-enrich-dossier` (*/5). Queue drains server-side from now on (589 pending at switch-over); local workers + date backfill restarted as accelerators. person_links 940 and climbing.
